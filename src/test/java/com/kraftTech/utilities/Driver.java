            ...
            switch (browser) {
                ...
                case "remote_chrome":
                    ...
                    try{
                        ...
                        //driverPool.set(new RemoteWebDriver(new URL("http://192.168.1.10:4444/wd/hub"),chromeOptions));
                ...
                case "remote_firefox":
                    ...
                    try{
                        ...
                        //driverPool.set(new RemoteWebDriver(new URL("http://192.168.1.10:4444/wd/hub"),firefoxOptions));
